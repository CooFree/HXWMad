 ...
 */
typedef void (^HYBDownloadProgress)(NSProgress *progress,int64_t bytesRead,
 ...
 */
typedef void (^HYBUploadProgress)(NSProgress *progress,int64_t bytesWritten,
...
typedef NSURLSessionDownloadTask HYBURLSessionDownloadTask;
typedef NSURLSessionUploadTask HYBURLSessionUploadTask;
